...
public class ThreadedServer
{
	...
	public static void main(String args[]) {
        ...
        while (listening) // almost infinite loop - loop once for each client request
        {
            ...
            ThreadedConnectionHandler con = new ThreadedConnectionHandler(clientSocket, gui, robotList);
            con.start(); 
            robotList = con.robotList;
            gui.robotList = robotList;
